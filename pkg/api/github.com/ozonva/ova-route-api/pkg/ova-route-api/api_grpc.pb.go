...
type RouteClient interface {
	...
	DescribeRoute(ctx context.Context, in *CreateRouteRequest, opts ...grpc.CallOption) (*RouteResponse, error)
	ListRoutes(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRoutesResponse, error)
	RemoveRoute(ctx context.Context, in *CreateRouteRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *routeClient) CreateRoute(ctx context.Context, in *CreateRouteRequest, opts ...grpc.CallOption) (*RouteResponse, error) {
...
func (c *routeClient) DescribeRoute(ctx context.Context, in *CreateRouteRequest, opts ...grpc.CallOption) (*RouteResponse, error) {
	out := new(RouteResponse)
...
func (c *routeClient) ListRoutes(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRoutesResponse, error) {
...
func (c *routeClient) RemoveRoute(ctx context.Context, in *CreateRouteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type RouteServer interface {
	...
	DescribeRoute(context.Context, *CreateRouteRequest) (*RouteResponse, error)
	ListRoutes(context.Context, *empty.Empty) (*ListRoutesResponse, error)
	RemoveRoute(context.Context, *CreateRouteRequest) (*empty.Empty, error)
...
func (UnimplementedRouteServer) CreateRoute(context.Context, *CreateRouteRequest) (*RouteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateRoute not implemented")
}
func (UnimplementedRouteServer) DescribeRoute(context.Context, *CreateRouteRequest) (*RouteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DescribeRoute not implemented")
}
func (UnimplementedRouteServer) ListRoutes(context.Context, *empty.Empty) (*ListRoutesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListRoutes not implemented")
}
func (UnimplementedRouteServer) RemoveRoute(context.Context, *CreateRouteRequest) (*empty.Empty, error) {
...
func _Route_DescribeRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServer).DescribeRoute(ctx, req.(*CreateRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Route_ListRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServer).ListRoutes(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Route_RemoveRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteServer).RemoveRoute(ctx, req.(*CreateRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
